...
uint8_t packet7[] = {};
  ...
  switch (p) {
    ...
    case FINGERPRINT_BADPACKET:
      ...
      return p;
    default:
      Serial.println("Unknown error uploadModel"); Serial.println(p);
      //return p;
  }
      
  Serial.println("Attempting to get Templete");
...
int getFingerprintIDez() { 
  p = -1;
  Serial.println("Waiting for valid finger as uploaded templete");
  ...
  if (p != FINGERPRINT_OK) 
  {
	  Serial.print("\t ===??? [ DOESN'T Match ]"); Serial.println();
	  delay(500);
